...
SECRET_KEY = 'django-insecure-e)2vq+u8a8!lwd29!!yu(07^9wnu=azb#e&lo8s)9pkv6iv6gc'
...
CELERY_BEAT_SCHEDULE = {
    'retrieving_posts': {
        'task': 'blog.tasks.retrieve_post_task',
        'schedule': crontab(minute='*/2'),  # run at midnight every day
        # 'schedule': crontab(),  # run at midnight every day
    },
